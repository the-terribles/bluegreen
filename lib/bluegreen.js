...
class BlueGreen {
  ...
  constructor(options){
    ...
    this.modules = {
      ...
      commands: [
        './modules/commands/list-versions',
        './modules/commands/delete-version',
        './modules/commands/list-environments',
        './modules/commands/list-environments-for-service',
        './modules/commands/deploy-version',
        './modules/commands/list-gateways',
        './modules/commands/debug-codebase-version'
      ],
      strategies: [
        {
          path: './modules/strategies/eb-env-and-versioning',
          instantiate: true
        },
        {
          path: './modules/strategies/elb-gateway',
          instantiate: true
        },
        {
          path: './modules/strategies/git',
          instantiate: true
        }
      ],
