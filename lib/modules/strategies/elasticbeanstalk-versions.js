...
class ElasticBeanstalkVersioningStrategy extends ElasticBeanstalkStrategy {
  ...
  register(bluegreen, callback){
    super.register(bluegreen, (err) => {
      ...
      bluegreen.registerCommand(new (require('../commands/create-version'))());
      bluegreen.registerCommand(new (require('../commands/delete-version'))());
      bluegreen.registerCommand(new (require('../commands/deploy-version'))());
      bluegreen.registerCommand(new (require('../commands/list-versions'))());
